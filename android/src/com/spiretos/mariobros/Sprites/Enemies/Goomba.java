...
public class Goomba extends Enemy {
    ...
    public Goomba(PlayScreen screen, float x, float y) {
        ...
        walkingAnimation = new Animation<TextureRegion>(0.4f, frames);
        stateTime = 0;
    ...
    public void update(float dt) {
        ...
        if(setToDestroy && !destroyed) {
            ...
            setRegion(walkingAnimation.getKeyFrame(stateTime, true));
        }
    }
    ...
    public void hitOnHead(Mario mario) {
        setToDestroy = true;
        MarioBros.manager.get("audio/sounds/stomp.wav", Sound.class);
    }
